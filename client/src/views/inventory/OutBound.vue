              ...
              <template v-slot="scope">
                <el-dropdown>
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item
                      ><el-button type="text" @click="onEditOutBound(scope.row)"
                        >修改</el-button
                      ></el-dropdown-item
                    >
                    <el-dropdown-item
                      ><el-button
                        type="text"
                        @click="onDeleteOutBound(scope.row, scope.$index)"
                        >删除</el-button
                      ></el-dropdown-item
                    >
                  </el-dropdown-menu>
...
export default {
  ...
  methods: {
    getProfile() {
      // 获取数据
      this.$axios('/api/outbound').then(res => {
    ...
    onDeleteOutBound(row, index) {
      // 删除
      this.$axios.delete(`/api/outbound/delete/${row._id}`).then(res => {
        this.$message('删除成功')
        this.getProfile()
      })
    },

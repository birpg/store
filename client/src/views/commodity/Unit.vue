<template>
  <div class="home">
    ...
    <!-- 弹框页面 -->
    <DialogUnit :dialog="dialog" :form="form" @update="getProfile"></DialogUnit>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    onDeleteUnit(row, index) {
      // 删除
      this.$axios.delete(`/api/unit/delete/${row._id}`).then(res => {
        this.$message('删除成功')
        this.getProfile()
      })
    },
